...
// Тестовые данные
const mockData = [
  { id: '1', name: 'Проект А', status: 'active', category: 'development', date: new Date('2023-01-15') },
  { id: '2', name: 'Проект Б', status: 'completed', category: 'design', date: new Date('2023-02-20') },
  { id: '3', name: 'Проект В', status: 'paused', category: 'development', date: new Date('2023-03-10') },
  { id: '4', name: 'Проект Г', status: 'active', category: 'marketing', date: new Date('2023-04-05') },
  { id: '5', name: 'Проект Д', status: 'completed', category: 'design', date: new Date('2023-05-12') },
  { id: '6', name: 'Проект Е', status: 'active', category: 'development', date: new Date('2025-04-04') },
];
...
const FILTER_OPTIONS: FilterOption[] = [
  ...
  },
  {
    ...
    options: [
      { value: '', label: 'Все' },
      { value: 'development', label: 'Разработкаfgjhkjkhfgkhjfgjkh hkkjgf kjkhgf hkjkj fghkkjfg hkj' },
...
const TestFilterPage: React.FC = () => {
  ...
  const { filters, setFilter, resetFilters } = usePageFilters(PAGE_ID);
  ...
  const getStatusBadgeVariant = useCallback((status: string): 'default' | 'success' | 'warning' | 'error' => {
    switch (status) {
