  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <Typography variant="b2Regular" className="mb-8">
        Hint (подсказка) отображает дополнительную информацию при наведении на элемент. Подсказка
        появляется с задержкой 100мс и исчезает с такой же задержкой при уходе курсора.
      </Typography>
      ...
      <div className="mb-8">
        ...
        <Typography variant="b3Regular" className="mb-4">
          По умолчанию Hint отображается в правом нижнем углу от курсора. При приближении к границам
          экрана позиция меняется автоматически. Можно также задать фиксированную позицию.
        </Typography>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="border rounded-md p-6">
          <Typography variant="b3Semibold" className="mb-3">
            Базовый вариант
          </Typography>
        ...
        <div className="border rounded-md p-6">
          ...
          <div className="flex justify-center">
            <Hint label="Информация" content="Подсказка с тегом-меткой вверху">
              <Button variant="secondary" size="medium">
                Hint с тегом
              </Button>
            </Hint>
          ...
          <div className="flex justify-center">
            <Hint
              label={[
                'Важно',
                'Новое',
                <Tag key="custom" className="bg-blue-100 border-blue-300">
                  Специально
                </Tag>
              ]}
        ...
        <div className="border rounded-md p-6">
          ...
          <div className="flex justify-center">
            <Hint content="Подсказка для текста">
              <span className="text-blue-500 underline cursor-pointer">Наведите на этот текст</span>
            </Hint>
          </div>
        </div>
      ...
      <Typography variant="b3Regular" className="mb-4">
        Компонент Tag используется в Hint в качестве метки, но также может быть использован
        самостоятельно.
      </Typography>
