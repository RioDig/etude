...
export const MOCK_SCHEDULE_TEMPLATES: CourseTemplate[] = [
  {
    course_template_id: '1',
    course_template_name: 'JavaScript для начинающих',
    course_template_description: 'Базовый курс по JavaScript для разработчиков',
  ...
  },
  {
    ...
    course_template_startDate: '2025-05-20',
    course_template_endDate: '2025-05-22',
  ...
  {
    course_template_id: '6',
    course_template_name: 'React и Redux в современной разработке',
    course_template_description: 'Продвинутый курс по React и Redux с практическими примерами',
    course_template_type: 'Course',
    course_template_track: 'Hard Skills',
    course_template_format: 'Online',
    course_template_trainingCenter: 'Академия Веб-разработки',
    course_template_startDate: '2025-06-15',
    course_template_endDate: '2025-07-30',
    course_template_link: 'https://webacademy.example/react-redux'
  },
  {
    course_template_id: '7',
    course_template_name: 'Лидерство и управление командой',
    course_template_description: 'Интенсивный тренинг для руководителей и менеджеров',
    course_template_type: 'Workshop',
    course_template_track: 'Management Skills',
    course_template_format: 'Offline',
    course_template_trainingCenter: 'Бизнес-школа Профессионал',
    course_template_startDate: '2025-05-25',
    course_template_endDate: '2025-05-27',
    course_template_link: 'Москва, Бизнес-центр "Сити", 3 этаж'
  },
  {
    course_template_id: '8',
    course_template_name: 'Frontend Developer Conference 2025',
    course_template_description: 'Международная конференция для frontend-разработчиков',
    course_template_type: 'Conference',
    course_template_track: 'Hard Skills',
    course_template_format: 'Offline',
    course_template_trainingCenter: 'DevConf',
    course_template_startDate: '2025-08-10',
    course_template_endDate: '2025-08-12',
    course_template_link: 'Москва, КЦ "Сокольники"'
  }
]
