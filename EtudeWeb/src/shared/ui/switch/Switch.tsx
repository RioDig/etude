        ...
        return (
          ...
          >
            {option.icon && React.cloneElement(option.icon, {
              ...
              className: clsx(option.label && 'mr-2', 'flex-shrink-0', option.icon.props.className)
            })}
