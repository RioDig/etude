...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center min-h-[26px] px-2 rounded-[4px] text-b4-regular'
  ...
  return (
    <div className={clsx(baseStyles, variantStyles[variant], className)} data-testid={testId}>
      {leftIconElement}
      <span>{children}</span>
      {rightIconElement}
    </div>
